...
const ProductForm = ({ visible, editingProduct, hideModal }) => {
    ...
    return (
        <CModal visible={visible} onClose={hideModal} size="lg">
            <CModalHeader>
            ...
            <CModalFooter>
                <CButton color="secondary" onClose={hideModal}>Cancel</CButton>
